...
- Threshold: **0.470**
- Precision (PCL): **0.6368**
- Recall (PCL): **0.6432**
- F1 (PCL): **0.6400**
- Confusion counts: TP=128, FP=73, FN=71, TN=1821
...
- Typical indicators: low `dev_f1`, near-constant probabilities (`dev_prob_std`), and extreme positive prediction rate.
