#!/usr/bin/env python3
"""Create final submission files from BestModel ensemble outputs."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Directory containing ensemble dev/test predictions and summary.",
    )
...
def main() -> None:
    ...
    if not src_dev.exists() or not src_test.exists():
        raise FileNotFoundError(
            ...
            "Run `python -m BestModel.run_pipeline` first."
        )
